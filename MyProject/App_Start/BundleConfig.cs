    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundles/jqgrid/css").Include(
                "~/Vendor/bootstrap.jqgrid-master/css/ui.jqgrid.css",
                "~/Vendor/bootstrap.jqgrid-master/css/jquery-ui-1.10.4.custom.css"));

            bundles.Add(new ScriptBundle("~/bundles/jqgrid/js").Include(
                     "~/Vendor/bootstrap.jqgrid-master/js/jquery.jqGrid.src.js",
                     "~/Vendor/bootstrap.jqgrid-master/js/grid.locale-cn.js"));


            //jqGrid for Bootstrap
            bundles.Add(new StyleBundle("~/bundles/jqgridBootstrap/css").Include(
                "~/Vendor/Guriddo_jqGrid_JS_5_2_X/css/ui.jqgrid-bootstrap.css"));

            bundles.Add(new ScriptBundle("~/bundles/jqgridBootstrap/js").Include(
                     "~/Vendor/Guriddo_jqGrid_JS_5_2_X/js/jquery.jqGrid.min.js",
                     "~/Vendor/Guriddo_jqGrid_JS_5_2_X/js/grid.locale-en.js"));



            //newdatetimepicker js
            bundles.Add(new ScriptBundle("~/bundles/newdatetimepicker/js").Include(
